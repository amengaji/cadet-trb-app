...
// using the newer expo-sqlite API (openDatabaseSync + execAsync).
...
export function getDatabase(): AppDatabase {
  if (!dbInstance) {
    // Newer expo-sqlite API: openDatabaseSync (synchronous open)
 ...
 * Uses execAsync to run multiple CREATE TABLE statements in one go.
 */
...
/**
 * Run a SELECT query and get all rows as plain JS objects.
 */
...
/**
 * Run an INSERT/UPDATE/DELETE query (no rows returned).
 */
